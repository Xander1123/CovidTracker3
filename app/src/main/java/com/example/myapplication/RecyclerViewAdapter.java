...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.RecyclerViewHolder> {
    ...
    public void onBindViewHolder(@NonNull RecyclerViewHolder holder, int position) {
        ...
        String lastUptd=coronaItem.getLastUpdated();
        String todayDeath=coronaItem.getTodayDeath();
        String todayActive=coronaItem.getTodayActive();
        String todayRecorver=coronaItem.getTodayRecovered();
    ...
    class RecyclerViewHolder extends RecyclerView.ViewHolder{
        TextView state,death,recovered,active,confirmed,lastUptade,todayDeath,todayActive,todayRecovered;
        public RecyclerViewHolder(@NonNull View itemView){
            ...
            lastUptade=itemView.findViewById(R.id.lastUpdated);
